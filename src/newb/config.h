...
/* Lighting */
#define NL_SUNLIGHT_INTENSITY   1.5  // 1.0 weak ~ 5.0 bright
...
#define NL_DAWN_SUNLIGHT_COL    vec3(1.00, 0.68, 0.50)
#define NL_NOON_SUNLIGHT_COL    vec3(1.00, 0.98, 0.92)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.60, 0.67, 0.85)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL vec3(1.0,0.48,0.15)
...
#define NL_RAIN_MIST_OPACITY 0.9 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow
...
#define NL_DAWN_ZENITH_COL   vec3(0.40,0.55,0.85)
#define NL_DAWN_HORIZON_COL  vec3(1.00,0.65,0.45)
#define NL_DAWN_EDGE_COL     vec3(1.00,0.78,0.65)
#define NL_DAY_ZENITH_COL    vec3(0.53,0.81,1.00)
#define NL_DAY_HORIZON_COL   vec3(0.75,0.88,1.00)
#define NL_DAY_EDGE_COL      vec3(0.85,0.93,1.00)
#define NL_NIGHT_ZENITH_COL  vec3(0.02,0.03,0.08)
#define NL_NIGHT_HORIZON_COL vec3(0.05,0.08,0.15)
#define NL_NIGHT_EDGE_COL    vec3(0.08,0.10,0.18)
#define NL_RAIN_ZENITH_COL   vec3(0.58,0.66,0.76)
#define NL_RAIN_HORIZON_COL  vec3(0.72,0.76,0.80)
...
#define NL_WATER_TINT vec3(0.24,0.46,0.89)
...
#define NL_GODRAY 0.2 // [toggle] 0.1 subtle ~ 0.8 strong
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.47 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
