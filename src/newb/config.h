...
#define NL_DAWN_SUNLIGHT_COL    vec3(1.0,0.55,0.25)
#define NL_NOON_SUNLIGHT_COL    vec3(1.0,0.92,0.85)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.12,0.10,0.09)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,0.78,0.45)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.78,0.45)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.78,0.45)
#define NL_END_TORCH_COL        vec3(1.0,0.78,0.45)
...
#define NL_DAWN_ZENITH_COL   vec3(0.85,0.45,0.30)
#define NL_DAWN_HORIZON_COL  vec3(1.60,0.65,0.35)
#define NL_DAWN_EDGE_COL     vec3(1.80,0.85,0.65)
#define NL_DAY_ZENITH_COL    vec3(0.35,0.65,1.00)
#define NL_DAY_HORIZON_COL   vec3(0.75,0.90,1.00)
#define NL_DAY_EDGE_COL      vec3(1.00,1.00,1.00)
#define NL_NIGHT_ZENITH_COL  vec3(0.03,0.05,0.12)
#define NL_NIGHT_HORIZON_COL vec3(0.06,0.08,0.16)
#define NL_NIGHT_EDGE_COL    vec3(0.09,0.10,0.18)
#define NL_RAIN_ZENITH_COL   vec3(0.45,0.55,0.65)
#define NL_RAIN_HORIZON_COL  vec3(0.65,0.72,0.78)

#define NL_END_ZENITH_COL    vec3(0.15,0.00,0.20)
#define NL_END_HORIZON_COL   vec3(0.40,0.10,0.50)
...
#define NL_WATER_TINT vec3(0.25,0.55,0.95)
...
#define NL_CLOUD2_SHAPE vec2(1.0, 1.0)     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
#define NL_CLOUD2_DENSITY 30.0             // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_VELOCITY 0.6             // 0.0 static ~ 4.0 very fast
...
/* Shooting star */
#define NL_SHOOTING_STAR 0.2        // [toggle] 0.2 dim ~ 1.0 bright
#define NL_SHOOTING_STAR_PERIOD 12.0 // 0.4 fast ~ 12.0 slow (12 secs)
#define NL_SHOOTING_STAR_DELAY 100.0 // 0.0 no delay ~ 100.0 long time (100 secs)
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.51 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
